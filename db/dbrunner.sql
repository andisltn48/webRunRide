...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 27 Apr 2021 pada 00.36
...
--
-- Struktur dari tabel `collecteddata`
--
...
(41, '2021_04_25_194449_create_countrylist', 1),
(42, '2021_04_25_194501_create_citylist', 1),
(43, '2021_04_25_194520_create_statelist', 1),
(74, '2014_10_12_000000_create_users_table', 2),
(75, '2014_10_12_100000_create_password_resets_table', 2),
(76, '2016_08_03_072729_create_provinces_table', 2),
(77, '2016_08_03_072750_create_cities_table', 2),
(78, '2016_08_03_072804_create_districts_table', 2),
(79, '2016_08_03_072819_create_villages_table', 2),
(80, '2019_08_19_000000_create_failed_jobs_table', 2),
(81, '2021_04_25_061348_create_user_data', 2),
(82, '2021_04_26_104753_create_collecteddata', 2),
(83, '2021_04_26_110328_create_tempodata', 2);
...
CREATE TABLE `tempodata` (
  ...
  `kategori` enum('Pelajar','Mahasiswa / Umum') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `klasifikasi` enum('Ride','Run') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ukuran` enum('S','M','L','XL') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pembayaran` enum('BCA','OVO','Dana') COLLATE utf8mb4_unicode_ci NOT NULL,
  `totalpembayaran` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Indeks untuk tabel `collecteddata`
--
...
--
-- AUTO_INCREMENT untuk tabel `collecteddata`
--
ALTER TABLE `collecteddata`
...
--
-- AUTO_INCREMENT untuk tabel `tempodata`
--
ALTER TABLE `tempodata`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
