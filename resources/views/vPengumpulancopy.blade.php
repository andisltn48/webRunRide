...
<div class="container-fluid">
    ...
    @endif
  <form method="POST" action="{{ route('pengumpulan.data.store', 2) }}" enctype="multipart/form-data">
    @csrf
        ...
        <div class="form-group">
            ...
            <input class="form-control" id="exampleFormControlInput1" name="nama" value="" >
            <div class="text-red">
              @error('nama')
                  {{ $message }}
              @enderror
